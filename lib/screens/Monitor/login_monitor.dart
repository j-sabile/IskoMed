...
class LoginMonitorPage extends StatefulWidget {
  const LoginMonitorPage({super.key});
  @override
  _LoginMonitorPageState createState() => _LoginMonitorPageState();
}

class _LoginMonitorPageState extends State<LoginMonitorPage> {
  @override
  Widget build(BuildContext context) {
      ...
      child: ElevatedButton(
        ...
        onPressed: () async {
          if (_formKey.currentState!.validate()) {
            ...
            String result = await context.read<AuthProvider>().signInMonitor(
            ...
            if (result == "Success") {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EntryPointPage(userType: "Monitor"),
                  ));
            } else {
              _errorAlert(result);
            }
    ...
    final signUpButton = Padding(
      ...
      child: TextButton(
        onPressed: () async {
          Navigator.pushNamed(context, '/signup-monitor');
        },
            ...
            children: <Widget>[
              ...
              Form(
                ...
                child: Column(children: [
                  ...
                  Padding(
                      padding: const EdgeInsets.all(5), child: signUpButton),
                ]
                    // signUpButton
                    ),
              ),
